...
namespace WritterKatarinaLoL
{
    ...
    // Vas a crear una aplicación de consola que preguntará en qué formato quieres la salida del objeto que tiene en memoria así pues al final tendrás un archivo llamado
    ...
    //una serie de formateadores que provee de una trasformación del objeto y de una extensión de archivo (no hace falta que creéis la serialización en los formateadores,
    //  podéis devolver hola mundo desd xmls, o desde json)
    //una clase Factory la cual le pasaras un comando y te devolverá un objeto Writer con el formateador pasado
    //la clase Factory recibe por ctor un diccionario o lista de tuplas o array de dos dimensiones o....con la relación entre un string { json, xml, plain }
    //    y las implementaciones de formateadores { jsonformateador, xmlformateador, plainformateador} (o si queréis enum de tipos en vez de string)
    ...
    //  (tip: 2 FactoryWriters + el builder le pasamos la decisión, utilizad IFs en el contenedor)
        ...
        static void Main(string[] args)
        {
            ...
            Factory containerLocal = container.CrearLocalWritter();
            FactoryCloud containerCloud = container.CrearCloudWritter();
